...
pub(crate) fn image_plan_payload(plan: &gugu_compiler::ImagePlan) -> Value {
    json!({
        ...
        "x64-metadata-schema": plan.x64_metadata_schema(),
        "x64-stackmap-section": plan.x64_stackmap_section(),
        "x64-stackmap-bytes": plan.x64_stackmap_bytes(),
        ...
        "x64-unwind-landings": plan.x64_unwind_landings(),
