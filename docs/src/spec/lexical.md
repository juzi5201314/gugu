...
词法诊断使用稳定代码 `E0009`–`E0019`：未闭合字面量或属性括号、未闭合块注释、非法转义、非法数字、非法记号、未知属性、非法属性参数、非法 Unicode scalar、C 字符串内嵌 0、非法字节字符、非法 f-string 格式说明。它们与源码快照诊断 `E0001`–`E0008` 一起按本节顺序排序。
